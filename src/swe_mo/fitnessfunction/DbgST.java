...
public class DbgST {
	...
	public static void main(String[] args) throws Exception {	
		try {
		//FitnessFunctionManager.add("f_{a}(x,n)=20x_{3\\pi}(23a)+\\cos^2{abccos}+20\\prod_{a=0}^{[(n+1)-1]}((5+x_a-3)+(x_1/2\\cos 3)\\sqrt[(25x)]{2n})+x_3+ rand((a_{x-1}),1)"); 
		...
		FitnessFunctionManager.add("f_(x,n)=x_2");
