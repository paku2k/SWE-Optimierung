...
public class PSOgnsc extends PSOnsc {
	...
	public PSOgnsc(int dimension, double min, double max, int particleCount, double w, double cc, double cs, double dt, int numIter,  int ffID, int solverID, int neighbors) throws Exception {
		super(dimension, min, max, particleCount, w, cc, cs, dt, numIter, ffID, solverID, neighbors);
	}
